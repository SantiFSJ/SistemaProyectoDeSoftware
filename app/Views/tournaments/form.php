...
background: linear-gradient(90deg, rgba(34,70,195,1) 0%, rgba(174,45,253,1) 100%);">
              ...
              <form action="<?= base_url("tournaments/save")?>" method="post" name="Guardar">
                    ...
                    <div class="form-group">
                        ...
                        <input required type="date" class="form-control form-control-border" name="start_date" id="tournamentStartingDate" placeholder="Ingresa la fecha de inicio del torneo" value="<?=(isset($tournament['star_date'])) ? $tournament['star_date'] : ''?>">
