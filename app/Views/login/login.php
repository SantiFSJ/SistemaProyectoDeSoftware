...
<body class="color-back">
    ...
    <div class="card" >
            <div class="card-header" style="background-color:silver">
              ...
              <div class="card-body">
              <form action="<?= base_url("login/save")?>" method="post" name="Guardar">
                    <?= csrf_field() ?>
                    <div class="form-group">
                        <label for="tournamentName">Nombre de Usuario:</label>
                        <input required type="text" class="form-control form-control-border" name="username" id="username" placeholder="Ingresa tu usuario">
                        <label for="tournamentStartingDate">Contraseña:</label>
